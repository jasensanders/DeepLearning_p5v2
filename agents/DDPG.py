...
class DDPG():
    ...
    def __init__(self, task):
        ...
        # In network version 3 I upped tau to let the quadcopter try to recover faster.
        ...
        # Average reward
        self.avg_reward = 0.0
        # Best reward for this agent instance in all episodes
    ...
    def step(self, action, reward, next_state, done):
        ...
        # Add rewards, count to totals
        self.total_reward += reward
        self.count += 1
        # Update current avg and best rewards
        self.avg_reward = self.total_reward / float(self.count) if self.count else 0.0
